...
const JavaScriptEssentials = () => {
  ...
  const curriculum = [
    { module: "Module 1: JavaScript Basics", topics: ["Variables & Data Types", "Operators", "Conditionals", "Loops"], duration: "2 weeks" },
    { module: "Module 2: Functions & Scope", topics: ["Function Declaration", "Arrow Functions", "Closures", "Scope Chain"], duration: "2 weeks" },
    { module: "Module 3: ES6+ Features", topics: ["Destructuring", "Promises", "Async/Await", "Modules"], duration: "2 weeks" },
    { module: "Module 4: DOM & Projects", topics: ["DOM Manipulation", "Event Handling", "Project Building", "Debugging"], duration: "2 weeks" },
  ];

  const features = [
    { icon: Code, title: "Interactive Labs", desc: "Code and practice in browser" },
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
              JavaScript <span className="gradient-text">Essentials</span>
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
              Master JavaScript fundamentals and ES6+. Learn to build interactive web applications and understand modern programming concepts.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">2.8K+ Enrolled</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="container mx-auto max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card rounded-xl p-6 sm:p-8 mb-12 sm:mb-16">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <a href={`/enroll?course=${encodeURIComponent("JavaScript Essentials")}`} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-4 font-semibold text-primary-foreground hover:opacity-90 transition-opacity glow">
                Enroll Now
              </a>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 sm:mb-16">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {["Master JavaScript fundamentals", "Write modern ES6+ code", "Build interactive applications", "Understand async programming", "Debug like a pro", "Real-world project development"].map((outcome, idx) => (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center">
            <h2 className="font-heading text-2xl sm:text-3xl font-bold mb-4">Ready to Master JavaScript?</h2>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join 2,800+ students. Get lifetime access to all course materials.
            </p>
            <a href={`/enroll?course=${encodeURIComponent("JavaScript Essentials")}`} className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-4 font-semibold text-primary-foreground hover:opacity-90 transition-opacity glow">
              <Play size={18} />
              Start Course Now
            </a>
          </motion.div>
