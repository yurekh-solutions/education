...
const ReactDevelopment = () => {
  ...
  const curriculum = [
    { module: "Module 1: React Fundamentals", topics: ["Components", "JSX", "Props", "State Management"], duration: "2.5 weeks" },
    { module: "Module 2: Advanced Hooks", topics: ["useState", "useEffect", "useContext", "Custom Hooks"], duration: "2.5 weeks" },
    { module: "Module 3: Routing & Navigation", topics: ["React Router", "Dynamic Routes", "Navigation", "URL Params"], duration: "1.5 weeks" },
    { module: "Module 4: State Management", topics: ["Redux Basics", "Context API", "State Architecture", "Real Projects"], duration: "2 weeks" },
  ];
  const features = [
    { icon: Code, title: "Hands-on Projects", desc: "Build real React applications" },
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8">
              Master React.js and build modern web applications. Learn components, hooks, routing, and state management.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">1.9K+ Enrolled</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="container mx-auto max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card rounded-xl p-6 sm:p-8 mb-12 sm:mb-16">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                ...
                <h2 className="font-heading text-4xl sm:text-5xl font-bold gradient-text">₹5,999</h2>
                <p className="text-sm text-muted-foreground mt-2">One-time payment • Lifetime access</p>
              </div>
              <a href={`/enroll?course=${encodeURIComponent("React Development")}`} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-4 font-semibold text-primary-foreground hover:opacity-90 transition-opacity glow">
                Enroll Now
              </a>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 sm:mb-16">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {["Build React components", "Master React Hooks", "Implement routing", "State management", "API integration", "Deploy applications"].map((outcome, idx) => (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center">
            <h2 className="font-heading text-2xl sm:text-3xl font-bold mb-4">Ready to Master React?</h2>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Join 1,900+ students. Get lifetime access.
            </p>
            <a href={`/enroll?course=${encodeURIComponent("React Development")}`} className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-8 py-4 font-semibold text-primary-foreground hover:opacity-90 transition-opacity glow">
              <Play size={18} />
              Start Course Now
            </a>
          </motion.div>
