...
const UIUXDesign = () => {
  ...
  const curriculum = [
    ...
    {
      module: "Module 2: Figma Mastery",
      topics: ["Figma Basics", "Components", "Auto Layout", "Prototyping"],
      duration: "2 weeks",
    },
    {
      module: "Module 3: User Research",
      topics: ["User Interviews", "Personas", "User Journey Maps", "Usability Testing"],
      duration: "2 weeks",
    },
    {
      module: "Module 4: Wireframing & Prototyping",
      topics: ["Low-fi Wireframes", "High-fi Mockups", "Interactive Prototypes", "Design Systems"],
      duration: "3 weeks",
    },
    {
      module: "Module 5: UI Design",
      topics: ["Mobile Design", "Web Design", "Responsive Design", "Micro-interactions"],
      duration: "3 weeks",
    },
    {
      module: "Module 6: Portfolio & Handoff",
      topics: ["Case Studies", "Portfolio Building", "Developer Handoff", "Design Presentation"],
      duration: "3 weeks",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mb-4 sm:mb-6">
                Figma, design systems, user research, prototyping and handoff workflows. Create beautiful, user-centered designs.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Link 
                  to="/enroll?course=UI%2FUX%20Design"
        ...
        <div className="container mx-auto px-6">
          <div className="glass-card rounded-xl p-6 sm:p-8 lg:p-12 text-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto">
              Create stunning user experiences and launch your design career
            </p>
            <Link 
              to="/enroll?course=UI%2FUX%20Design"
              className="bg-primary text-primary-foreground px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity glow flex items-center gap-2"
